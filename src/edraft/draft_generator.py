...
class DraftGenerator:
    ...
    def build_prompt(
        ...
        *,
        ...
        style_block = self._render_style_examples(style_examples or [])
    ...
    def _render_style_examples(self, style_examples: list[StyleExample]) -> str:
            ...
            rendered.append(
                "\n".join(
                    [
                        ...
                        f"Correspondent: {example.correspondent_email}",
                        f"Subject: {example.subject}",
                        "Their message excerpt:",
                        example.inbound_text,
                        "Your reply excerpt:",
                        example.reply_text,
                    ]
                )
